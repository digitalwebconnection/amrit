      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12 max-w-7xl">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:w-5/12 flex flex-col items-center text-center lg:items-start lg:text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white border border-slate-200 mb-4 shadow-2xs">
            ...
            <div className="space-y-3.5 w-full max-w-md">
              ...
              {/* Location Pod */}
              <div className="flex items-start gap-4 p-3.5 rounded-xl bg-white border border-slate-200 shadow-xs">
